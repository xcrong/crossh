> **已归档（2026-08-18 完成，仅作历史档案）**：本文的 P1/P2 共 14 项已全部完成；后续简化见 `docs/audit/2026-08-20-simplification-audit.md`（S-1~S-10 已全部完成 2026-08-20）与 `docs/audit/2026-08-21-doc-drift-audit.md`。现行待办以最新审计与 `docs/specs/*` 为准。

# P1/P2 简化项任务清单（2026-08-17 审计 backlog）

## 完成状态（2026-08-18）

**全部完成 ✅**。P1 走 SDD 流程实现、P2 裁定后实现或文档化保留，共 14 个提交（`c1d42cc`…`7a6d731`）：

| 类别 | 项 | 提交 |
| --- | --- | --- |
| P1 | S-B1 死终端契约 | `c1d42cc` |
| P1 | S-B4 bootstrap 统一 | `2d7abb8` |
| P1 | S-B2 Password 变体 | `de370ed` |
| P1 | S-A1 + S-A10 编辑合并 | `3113257`（S-A10 文档记录 `3787062`） |
| P1 | S-D1 入口链收缩 | `49224db` |
| P2 | S-D10 死字段 | `1422290` |
| P2 | S-D13 release 校验去重 | `971b59a` |
| P2 | S-A5 刷新任务命名 | `c8c45fe` |
| P2 | S-A7 / S-A9 保留+注释 | `7692a14` / `62f4dcd` |
| P2 | S-C3 Separator 删除 | `6e90feb` |
| P2 | S-C5 / S-C7 / S-C8 保留+注释 | `760d4f8` / `78a4e20` / `833fc14` |
| P2 | S-D7 / S-D11 删除 | `9c6129d` / `7a6d731` |
| P2 | S-D15 Windows 资产拷贝 | 裁定**保持现状**（无代码改动） |
