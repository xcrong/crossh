...
pub(crate) const MAX_TITLE_COMPONENT_CHARS: usize = 25;
...
pub(crate) fn local_terminal_title(
    cwd: Option<&str>,
...
pub(crate) fn remote_terminal_title(title: Option<&str>) -> String {
    title
...
pub(crate) fn local_terminal_tab_title(title: &str, cwd: Option<&str>) -> String {
...
pub(crate) fn remote_pane_title(pane_type: &str) -> String {
...
pub(crate) fn strip_shell_host_prefix(value: &str) -> &str {
...
pub(crate) fn truncate_path_title(value: &str) -> String {
